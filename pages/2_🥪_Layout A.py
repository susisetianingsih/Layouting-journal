...
st.set_page_config(
    page_title="Layouting like JUPIN",
    page_icon="🥪"
)
...
def format_paragraph(paragraph, font_name="Times New Roman", font_size=11, italic="none", bold=False, alignment='justified', 
