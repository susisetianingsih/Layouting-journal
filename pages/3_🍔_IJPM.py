...
def fill_template(template_file, journal_info, loa_id, current_date, loa_name, romawi_bulan, tahun, vol_no):
    ...
    output_path_word = os.path.join("D:\\PROJECT\\IJPM\\LoA", f"{loa_name}.docx")
    output_path_pdf = os.path.join("D:\\PROJECT\\IJPM\\LoA", f"{loa_name}.pdf")
...
def extract_loa_name(file_name):
    ...
    if match:
        ...
        return loa_id, f"LOA IJPM_{loa_id} {loa_name}"
...
vol_no = st.text_input("Volume Nomor:", "Volume 2 Nomor 3 Desember 2024")
...
if uploaded_file is not None:
    ...
    TEMPLATE_PATH = "templates/LOA IJPM_.docx"
